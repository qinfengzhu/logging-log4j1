...
/**
 * 早期版本使用Category作为Facade方式调用
 * 现在版本使用Logger作为Facade门面方式调用
 */
public class Category implements AppenderAttachable {
     ...
     * 是否使用父类的appenders,当为false时候不使用父类appenders
     */
